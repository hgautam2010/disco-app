...
**Advertiser**
A business that wants to pay to put their product or message in front of people. In this exercise, the advertiser is the _user_. They describe their business and your system helps them set up a campaign. Examples: a dog food brand, a meditation app, a sustainable activewear company.
...
**Creative**
The actual ad: the headline, body copy, and visuals that a shopper sees. In this exercise, you're generating _text_ creative (headlines + body copy), not images. A "creative variant" is one version of an ad. Advertisers usually run multiple variants to test which performs best.
...
You're building the brain of an ad system: an advertiser tells you what they sell, and your system figures out _where_ their ads should run, _who_ the ads should speak to, and _what those ads should say_. The output is a draft campaign that a human (or downstream system) could review and launch.
...
- **Writing creative that actually fits the audience.** Generic ad copy is everywhere. Your system should generate copy that feels written _for_ a specific persona, not pasted in from a template.
...
- **Showing your work.** Black-box recommendations are hard to trust. The advertiser should be able to see _why_ your system made the calls it did.
